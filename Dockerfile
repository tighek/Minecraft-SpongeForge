...
ADD https://repo.spongepowered.org/maven/org/spongepowered/spongeforge/1.12.2-2586-7.1.0-BETA-2892/spongeforge-1.12.2-2586-7.1.0-BETA-2892.jar /srv/spongeforge.jar
RUN ln -s /srv/spongevanilla.jar /srv/minecraft/spongevanilla.jar

RUN touch /srv/spongeforge_1.12.2-2586-7.1.0-BETA-2892
